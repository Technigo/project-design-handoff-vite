...
export const Membership = () => {
  return (
    <div className="relative mb-[182px] md:mb-[334px] lg:mb-[640px]">
      ...
      <div className="z-0 flex h-[222px] w-auto justify-center gap-[25px] bg-pink px-[24px] pt-[23px] text-black md:h-[320px] md:gap-[60px] md:px-2 md:pt-[34px] lg:h-[549px] lg:gap-[162px] lg:px-[174px] lg:pb-[180px] lg:pt-[79px]">
        <div className="w-[90px] flex-col text-center md:w-[188px] lg:w-[256px]">
          ...
          <p className="pt-[5px] text-[14px] leading-[1rem] tracking-normal md:pt-[25px] md:text-base md:leading-none md:tracking-wide lg:pt-3 lg:text-[30px] lg:font-medium lg:tracking-normal ">
        ...
        <div className="w-[90px] flex-col text-center md:w-[188px] lg:w-[256px]">
          ...
          <p className="pt-[5px] text-[14px] leading-[1rem] tracking-normal md:pt-[25px] md:text-base md:leading-none md:tracking-wide lg:pt-3 lg:text-[30px] lg:font-medium lg:tracking-tight ">
