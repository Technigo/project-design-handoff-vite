...
export const HeroSection = () => {
  return (
    <div className=" bg-hero-small md:bg-hero-large -z-10 h-[340px] w-screen bg-cover bg-center md:h-[394px] lg:h-[776px]">
      <div className="-z-5 h-[340px] w-screen bg-dkpurple/50 md:h-[394px] lg:h-[776px]">
        <Header className="-z-1" />
        <div className="flex flex-col items-center justify-center text-center">
          <h1 className="mt-6 text-2xl leading-none md:text-4xl lg:mt-7 lg:text-[70px]">
            The Zumba Hall
          </h1>
