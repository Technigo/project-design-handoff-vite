...
export const FeatureReviewSection = ({ featureData, reviewData }) => {
  return (
    <div className="bg-background-neon-green">
      <div className="max-w-screen-xl m-auto flex flex-col desktop:flex-row">
        <div className="desktop:basis-7/12">
          {featureData.map((feature, index) => (
            <FeatureCard key={index} feature={feature} />
          ))}
        </div>
        <div className="flex flex-col tablet:flex-row desktop:flex-col tablet:basis-auto desktop:basis-5/12 justify-center">
