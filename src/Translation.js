...
const resources = {
    en: {
        translation: {
            ...
            gridText1: "Start your day with our breakfast buffet starting from 5:00 AM, including a juice bar and a Protein Bar for post-workout energy.",

            gridTitle2: "The Gym",
            gridText2: "Transform your fitness journey at our state-of-the-art gym, the newest machines, yoga area and an open snack bar.",

            gridTitle3: "Co-working",
            gridText3: "Elevate your productivity at our cutting-edge co-working space, an open space combined with private meeting areas, open fireplaces and much more.",

            gridTitle4: "Spa & Wellness",
            gridText4: "Discover tranquility at our spa and wellness area, unwind after a good workout, a long workday, or whenever life calls for it.",
            ...
            aboutText: "Many gyms build their business model on the bet that most people will stay home. We don’t.",
    ...
    sv: {
        translation: {
            ...
            gridButton: "Läs mer",
            gridTitle1: "Frukost",
            gridText1: "Börja din dag med vår frukostbuffé som börjar kl. 05:00, inklusive en juicebar och en proteindrinkbar för efter-träningsenergi.",

            gridTitle2: "Gymmet",
            gridText2: "Förändra din träningsresa i vårt toppmoderna gym med de senaste maskinerna, ett yogahörn och en öppen snacksbar.",

            gridTitle3: "Delade ytor",
            gridText3: "Höj din produktivitet i vårt toppmoderna samarbetskontor, en öppen yta kombinerad med privata mötesområden, öppna spisar och mycket mer.",

            gridTitle4: "Spa & Välmående",
            gridText4: "Höj din produktivitet på vår toppmoderna samarbetsplats, en öppen yta kombinerad med privata mötesområden, öppna spisar och mycket mer.",

            gridTitle5: "In på småtimmarna",
            gridText5: "Anslut dig till oss för kvällsnöjen i vår cocktailbar med DJ eller liveframträdanden. Öppet varje fredag för alla och på lördagar endast för medlemmar.",

            //Info
            infoTitle1: "$1.13 milioner",
            infoText1: "Amerikaner spenderar 1,13 miljoner dollar årligen på oanvända gymmedlemskap.",
            infoTitle2: "$1.9 billioner",
            infoText2: "Australier slösar bort 1,9 miljarder dollar per år på oanvända gymmedlemskap.",
            ...
            aboutText: "Många gym bygger sin affärsmodell på att de flesta människor kommer att stanna hemma. Det gör inte vi.",
