...
const resources = {
    sv: {
        translation: {
            ...
            'LOG IN': 'LOGGA IN',
            'Welcome to our community of experienced teachers, where you will find classes for all levels.': 'Välkommen till vårt community av erfarna lärare, här finner du klasser för alla nivåer',
            'Join us for our heartwarming events, including workshops, teacher training, and retreats.': 'Var med på våra hjärtvärmande event, workshops, lärarutbildning, och retreats', 
