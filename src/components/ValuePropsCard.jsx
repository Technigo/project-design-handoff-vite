export const ValuePropsCard = ({
  ...
  return (
    <div className="bg-primary-valupropsviolet border border-black rounded flex flex-col items-center shadow-boxShadow w-52 lg:w-64 lg:h-96">
      <img
        src={image}
        className="rounded-full object-cover border-solid border border-black h-40 w-40 mt-6 lg:h-48 lg:w-48"
      ></img>
