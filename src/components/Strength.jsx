...
export const Strength = () => {
  return (
    <section className="flex flex-col justify-center p-2 gap-6 mx-2 tablet:mx-8 desktop:mx-36 font-Inter mb-8">
      <div className="">
        <img className="float-left mr-3 max-w-[120px] md:max-w-[350px] lg:max-w-[600px]" src={strength1} />
      ...
      <div className="">
        <img className="float-left mr-3 max-w-[120px] md:max-w-[350px] lg:max-w-[600px]" src={strength2} />
      ...
      <div>
        <img className="float-left mr-3 max-w-[120px] md:max-w-[350px] lg:max-w-[600px]" src={strength3} />
