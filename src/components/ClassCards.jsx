...
import ZumbaEnergetic from "../assets/ZumbaEnergetic.jpeg"
import ZumbaHeavy from "../assets/ZumbaHeavy.jpeg"
import JustZumba from "../assets/JustZumba.jpeg"

export const ClassCards = () => {
  return (
    <div className='flex flex-col justify-center items-center gap-y-5 px-[60px]'>
