...
const ImageContent = () => {
    return (
        <div className="text-center m-4 grid grid-cols-1 md:grid-cols-3 gap-4 border-t-4 border-black">
            <div className='mt-10'>
