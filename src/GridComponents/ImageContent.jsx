...
const ImageContent = () => {
    return (
        <div className="text-center m-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 border-t-4 border-black">
            ...
            <div className='mt-10'>
                <img className="" src={GridData[1].Image1} alt="Image 1" />
            </div>
            <div className='mt-10'>
            ...
            <div className='mt-10 flex flex-col items-center justify-center'>
                ...
                <button className='hover:shadow-yellow-box g-white w-44 border-solid border-2 border-black p-2 mb-4 mt-4'>{GridData[6].button}</button>
            </div>
            <div>
