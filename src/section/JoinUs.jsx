...
export const JoinUs = () => {
  ...
  return (
    <div className="container mx-auto flex flex-col items-center gap-28 px-9 md:gap-8">
   ...
   <Carousel showStatus={false} showIndicators={false}>
      ...
      <ButtonSecondary addedClasses="md:w-full md:rounded-custom-two" text={"Membership cards"} />
    ...
    <div>
      <Image
        ...
        className="w-width-two h-height-three pb-38 pt-3.5 object-cover object-right"
      />
      </div>
    </div>
  );
