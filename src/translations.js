...
const resources = {
  en: {
    translation: {
      ...
      infoText1:
        "Americans spend $1.13 million on unused gym memberships annually.",
      ...
      rightText: "So much money is being tossed away for nothing.",
      rightTextYellow: "We want to change it.",
      rightButton: "Read more about us",

      //Member
      memberTitle: "Become a Member",
      memberTitle1: "BRONZE",
      memberPrice1: "80€/month",
      memberText1: "Limited access to 2 facilities of your choice",
      memberText2: "Open snack / soft drinks bar",
      memberButton: "Read More",

      memberTitle2: "SILVER",
      memberPrice2: "100€/month",
      memberText3: "Limited access to 3 facilities of your choice",
      memberText4: "Open snack / soft drinks bar",
      memberText5: "Switch between facilities every 3rd month",
      memberText6: "Given 2 invites a month",
      memberButton: "Read More",

      memberTitle3: "GOLD",
      memberPrice3: "200€/month",
      memberText7: "Limited access to ALL facilities",
      memberText8: "Open snack / soft drinks bar",
      memberText9: "Private locker",
      memberText10: "Private parking space",
      memberText11: "Given 4 invites a month",
      memberButton: "Read More",
  ...
  sv: {
    translation: {
      ...
      title2: "ett ställe.",
      description:
        "Upp to 67 procent av traditionella gymmedlemskap används aldrig.",
      description2:
      ...
      gridTitle1: "Frukost",
      gridText1:
        "Börja din dag med vår frukostbuffé som börjar kl. 05:00, inklusive en juicebar och en proteindrinkbar för efter-träningsenergi.",
      ...
      rightText: "Så mycket pengar slösas bort i onödan.",
      rightTextYellow: "Vi vill ändra på det.",
      rightButton: "Läs mer om oss",

      //Member
      memberTitle: "Bli medlem",
      memberTitle1: "BRONS",
      memberPrice1: "80€/månad",
      memberText1: "Begränsad tillgång till 2 valfria faciliter.",
      memberText2: "Öppen snack-/läskbar",
      memberButton: "Läs mer",

      memberTitle2: "SILVER",
      memberPrice2: "100€/månad",
      memberText3: "Begränsad tillgång till 3 valfria faciliter.",
      memberText4: "Öppen snack-/läskbar",
      memberText5: "Byt mellan faciliteter var tredje månad",
      memberText6: "Får två inbjudningar per månad",
      memberButton: "Läs mer",

      memberTitle3: "GULD",
      memberPrice3: "200€/månad",
      memberText7: "Begränsad tillgång till ALLA faciliteter",
      memberText8: "Öppen snack-/läskbar",
      memberText9: "Privat skåp",
      memberText10: "Privat parkeringsplats",
      memberText11: "Får fyra inbjudningar per månad",
      memberButton: "Läs mer",
