    ...
    return (
        <div className="text-center absolute p-4 grid grid-cols-1 md:pt-20 grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="text-white pl-0 p-0 pt-0 lg:mr-36">
                ...
                <h1 className="pr-0 text-4xl pt-1 mt-0 md:text-6xl lg:pt-0">{t("infoTitle3")}</h1>
            ...
            <div className="flex flex-col justify-center items-center text-white">
                <div className="mt-0 pt-0 lg:border-b-4 border-white pb-10">
                    <h1 className="mt-0 text-4xl pt-0 md:text-6xl lg:pt-10 text-white">{t("rightText")}<h1 className="text-yellow-color">{t("rightTextYellow")}</h1></h1>
                </div>
                <button
